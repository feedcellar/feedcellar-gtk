...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Feedcellar::Gtk is a GTK+ interface for Feedcellar that is full-text searchable RSS feed reader and data store by Rroonga and Ruby/GTK2.}
